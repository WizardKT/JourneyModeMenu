...
public class ResearchSerializer {
    public static NBTTagCompound serialize(Research instance) {
        ...
        // Мини-подсказка: Сохраняем наш тумблер в самом начале NBT,
        // чтобы он лежал рядом с базовыми данными, а не в конце после списков.
    ...
    public static void deserialize(Research instance, NBTTagCompound nbt) {
        // Мини-подсказка: Всегда проверяем hasKey перед чтением,
        // чтобы старые сохранения игроков не крашнули игру из-за отсутствия тега!
